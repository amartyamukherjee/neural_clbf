...
class CarLikeRobot2(ControlAffineSystem):
    """
    """
    ...
    @property
    def n_dims(self) -> int:
        return CarLikeRobot2.N_DIMS

    @property
    def angle_dims(self) -> List[int]:
        return [CarLikeRobot2.THETA]

    @property
    def n_controls(self) -> int:
        return CarLikeRobot2.N_CONTROLS
    ...
    def state_limits(self) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        upper_limit[CarLikeRobot2.X] = 1.0
        upper_limit[CarLikeRobot2.Y] = 1.0
        upper_limit[CarLikeRobot2.THETA] = 10000.0
        upper_limit[CarLikeRobot2.PSI] = 10000.0
    ...
    def _g(self, x: torch.Tensor, params: Scenario):
        ...
        theta = x[:, CarLikeRobot2.THETA]
        psi = x[:, CarLikeRobot2.PSI]

        g[:,CarLikeRobot2.X,CarLikeRobot2.V] = torch.cos(theta)
        g[:,CarLikeRobot2.Y,CarLikeRobot2.V] = torch.sin(theta)
        g[:,CarLikeRobot2.THETA,CarLikeRobot2.V] = torch.tan(psi)/l
        g[:,CarLikeRobot2.PSI,CarLikeRobot2.W] = 1.0
