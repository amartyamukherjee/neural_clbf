...
class RoombaProblem1(ControlAffineSystem):
    """
    """
    ...
    @property
    def n_dims(self) -> int:
        return RoombaProblem1.N_DIMS

    @property
    def angle_dims(self) -> List[int]:
        return [RoombaProblem1.THETA]

    @property
    def n_controls(self) -> int:
        return RoombaProblem1.N_CONTROLS
    ...
    def state_limits(self) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        upper_limit[RoombaProblem1.X] = 1.0
        upper_limit[RoombaProblem1.Y] = 1.0
        upper_limit[RoombaProblem1.THETA] = 10000.0
    ...
    def _g(self, x: torch.Tensor, params: Scenario):
        ...
        theta = x[:, RoombaProblem1.THETA]

        g[:,RoombaProblem1.X,RoombaProblem1.V] = torch.cos(theta)
        g[:,RoombaProblem1.Y,RoombaProblem1.V] = torch.sin(theta)
        g[:,RoombaProblem1.THETA,RoombaProblem1.PHI] = 1.0
